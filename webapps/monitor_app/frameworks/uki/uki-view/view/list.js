...
uki.view.declare('uki.view.List', uki.view.Base, uki.view.Focusable, function(Base, Focusable) {
    ...
    */
    ...
    this.keys = function(k) {
    	if (k == undefined)	return this._keys;
    	this._keys = k;
    	return this;
    };
    ...
    */
    this.addRow = function(position, data, key) {
    ...
    */
    this.removeRow = function(position) {
        ...
        //khj
        if(this._keys != undefined && this._keys.length - 1 >= position) {
        	this._keys.splice(position, 1);
        }
...
//khj
uki.Collection.addAttrs(['data', 'selectedIndex', 'selectedIndexes', 'selectedRow', 'selectedRows', 'lastClickIndex', 'keys']);
