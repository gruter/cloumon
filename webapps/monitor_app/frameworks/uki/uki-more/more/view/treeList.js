...
uki.view.declare('uki.more.view.TreeList', uki.view.List, function(Base) {
    ...
    this._openSubElement = function(index) {
        ...
        //alert('data.length:' + this._data.length + ',listData:' + this.listData().length);
        return length;
    };

    this.lastOpenIndex = function() {
    	return this._lastOpenIndex;
    };
...
uki.Collection.addAttrs(['lastOpenIndex', 'treeData']);
